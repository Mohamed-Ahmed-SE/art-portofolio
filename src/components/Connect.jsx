            ...
            <div className="connect-section container">
                <div className="row justify-content-center mx-auto">
                    ...
                    <div className="connect-form p-0 col-11 col-lg-6">
                        <h2 className="connect-title w-100 text-center text-lg-start">Contact the Developer</h2>
                        <form ref={mainForm} onSubmit={handleSubmit}>
                            <div className="container-fluid">
                                <div className="row justify-content-center mx-auto">
                                    <div className="input-div col-12 col-lg-6">
                                        <input required type="text" name="firstName" id="firstName" placeholder="First Name (or Gallery)" />
                                    </div>
                                    <div className="input-div col-12 col-lg-6">
                                    ...
                                    <div className="input-div col-12 col-lg-12">
                                        <textarea name="message" id="message" placeholder="Message (commission, feedback, or collaboration)"></textarea>
                                        <ValidationError
                                            prefix="Message"
                                            field="message"
                                            errors={state.errors}
